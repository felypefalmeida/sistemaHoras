...
<h4> Nome: {{$nomeAlu->nome}}  </h4>
<h4> Matricula: {{$nomeAlu->matricula}} </h4>
 ...
 <br></br>
  <h1>Relatório de Atividades</h1>
   ...
   <h3 class=" text-success"> Possui <ins>{{$qtdHorasAluno}}</ins>  horas validadas.</h3>


  <h3 class="text-danger"> Possui  <ins>{{$restante}}</ins> horas faltando. </h3>
