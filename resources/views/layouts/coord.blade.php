  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <header class="main-header">
           ...
           <!-- Logo -->
            <a href="/coordenador/index"  class="logo">
          ...
          <ul class="sidebar-menu">
            ...
            <li>
              ...
              /grupo/cadastrar">
                ...
                <small class="label pull-right bg-primary">Grupo</small>
              </a>
            </li>  

            <li>
              <a href="{{route('coordenador.listaGrupo')}}">
                <i class="fa fa-eye"></i> <span>Listar</span>
                <small class="label pull-right bg-primary">Grupo</small>
              </a>
            </li> 
            <li>
              <a href="/coordenador/edit">
